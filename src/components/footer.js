    ...
    <footer>
        ...
        <div className="Informacije">
          <ul>
            ...
            <li onMouseEnter={() => onHover(1)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 1 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
            ...
            <li onMouseEnter={() => onHover(2)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 2 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
              <a href="/return-policy">Pravila povrata</a>
            </li>
            <li onMouseEnter={() => onHover(3)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 3 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
              <a href="/terms-of-use">Pravila pružanja usluge</a>
            </li>
          </ul>
          <ul>
            <li>
            ...
            <li onMouseEnter={() => onHover(4)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 4 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
            ...
            <li onMouseEnter={() => onHover(5)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 5 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
              <a href="/">O nama</a>
            ...
            <li onMouseEnter={() => onHover(6)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 6 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
            ...
            <li onMouseEnter={() => onHover(7)} onMouseLeave={HoverLeave}>
              <FontAwesomeIcon
                className={`footer-arrow ${hover === 7 ? "hovered" : ""}`}
                icon={faChevronRight}
                style={{ color: "#F9F7F7" }}
              />
      ...
      <div className="footer-bottom">
        ...
        <p>
          Boost Web{" "}
          <span>
            <FontAwesomeIcon icon={faCopyright} style={{ color: "#F9F7F7" }} />{" "}
          </span>
