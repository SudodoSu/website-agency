      ...
      <main className="contact-us">
          ...
          <form ref={form} onSubmit={sendEmail}>
            ...
            <div>
              ...
              >
                ...
                <option value="Web Development">Single Page</option>
                <option value="Web Solutions">Multi Page</option>
                <option value="Strategy and Research">Pro Page</option>
                <option value="Other">Other</option>
              </select>
            </div>
            <div className="contact-us-textarea-div">
              <textarea name="message" placeholder="Message" />
            </div>
            <div className={`submit-button ${clicked ? "clicked" : ""}`}>
        ...
        {messageSent && (
          <div className={`successfully-sent ${closed ? "closed" : ""}`}>
            <FontAwesomeIcon
              className="successfully-sent-check"
              icon={faCheck}
              size="2xl"
              style={{ color: "#45F248" }}
            />
            ...
            <FontAwesomeIcon
              onClick={handleClose}
              className="successfully-sent-close"
              icon={faX}
              style={{ color: "#F9F7F7" }}
            />
          </div>
