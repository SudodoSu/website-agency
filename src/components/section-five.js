...
function ClientWords() {
  ...
  const clients = [
    ...
    {
      des: "Oduševljen sam njihovim dizajnom i stručnošću. Moja e-trgovina nikada nije izgledala bolje, a prodaja se povećala od kada su preuzeli projekt.",
      name: "Ivana P.",
    },
    {
      des: "S njima je bilo čist zabavno. Skroz su skužili naš đir i napravili su stranicu kakvu smo priželjkivali. Ekipa za pet!",
      name: "Marko I.",
    },
    {
      des: "Zbilja znaju svoj posao. Dizajn stranice je vrhunski, i vidimo porast u prodaji.",
      name: "Ana K.",
    },
  ];
